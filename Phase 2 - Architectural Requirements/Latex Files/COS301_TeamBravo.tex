...
\begin{document}
	...
	\iffalse
		- the different access channels enabling human and system users to use your system (e.g. a web and mobile front-end and a web-services access channel)
		...
		- discuss any protocols and/or technologies you are using for those access and integration chan- nels 
	\fi
