...
\begin{document}
	...
	\subsection{Access and integration channels}
		...
		\begin{itemize}
			...
			\item RESTful web services, which are REST architecture based web services. Representational State Transfer (REST) is an architectural style that specifies constraints, such as the uniform interface, that if applied to a web service induce desirable properties, such as performance, scalability, and modifiability, to the system
		\end{itemize}
