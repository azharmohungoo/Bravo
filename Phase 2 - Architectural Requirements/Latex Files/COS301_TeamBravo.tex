...
\begin{document}
	...
	The MVC (Model View Control) architecture may be used in this system. The MVC architecture allows change to the system's state. The model is completed through a common interface(the control). The view is where developments are made to user interfaces and these changes are independent to the system providing extensibility at a low cost.
