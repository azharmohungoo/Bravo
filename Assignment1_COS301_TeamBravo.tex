...
We intend to create a system that will allow authors and their co-authors to work on their reseach papers in an environment that reassures collaborative work, which in turn diminishes the time spent on multi-authored papers.
